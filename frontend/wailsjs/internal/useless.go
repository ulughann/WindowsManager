...
func Useless() {
	...
	* You may ask then, why is it here?
	* Well, it's here because we've written too much .vue
	* in this project and marketing tells me
	* that the project overview on github should not
	* show Javascript under any circumstace because people
	* will think it's a frontend project. (or that it's painfully slow)

	* So, here we are, with a useless file.
	...
	* You bored?
	* Me aswell, let's read a story.
	**/

	fmt.Println("the quick brown fox jumps over the lazy dog")
	fmt.Println("after a long day of work, the fox goes home to his wife and kids")
	fmt.Println("he tells them about his day, and how he jumped over the lazy dog")
	fmt.Println("the kids are amazed, and ask him to tell the story again")
	fmt.Println("the fox tells the story again, and the kids are amazed again")
	fmt.Println("the fox's wife is not amazed, she's heard the story a million times")
	fmt.Println("she tells the fox to stop telling the story, but the kids want to hear it again")
	fmt.Println("the fox tells the story again, and the kids are amazed again")
	fmt.Println("the fox's wife is not amazed, she's heard the story a million times")
	fmt.Println("she tells the fox to stop telling the story, but the kids want to hear it again")
	fmt.Println("the fox tells the story again, and the kids are amazed again")
...
// The below code is a copy of the sha256 algorithm I took from github
var K = [64]uint32{
